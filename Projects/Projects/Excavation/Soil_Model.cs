    ...
    public class Soil_Model : Soil_Element
    {
        ...
        public bool RemoveSoil(Transaction tranDoc, Soil_Excav soilToRemove)
        {
            ...
            if (soilToRemove != null)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    //
                    throw new InvalidOperationException($"事务“{tranDoc.GetName()}”出错。土体开挖失败");
                }
            }
            return blnSucceed;
        }
        ...
        public List<ElementId> UnGroup(Transaction tranDoc)
        {
            if (!_isUnGrouped)
            {
                ...
                // 删除  group  的实例
                List<ElementId> excavSoilIds = this.GetExcavSoilsInGroup();
        ...
        {
            var elems = this.GetExcavSoilsInGroup();
        ...
        public bool[] ContainsExcavSoils(ICollection<ElementId> soilIds)
        {
            ...
            var excavSoilInGroup = this.GetExcavSoilsInGroup().Select(r => r.IntegerValue).ToArray();
            //
        ...
        /// <returns></returns>
        public List<ElementId> GetExcavSoilsInGroup()
        {
