    ...
    namespace SafetyWarning
    {
        public partial class FormSetWarning : Form
        {
            ...
            private void button1_Click(object sender, EventArgs e)
            {
                ...
                {
                    //保存
                    FileStream dataFile = new FileStream(Path.Combine(ProjectPath.Path_data, "WarningValue.dat"),
                        FileMode.Create);
                    ...
                    sw.Close();
                    //当前的选择
                    FileStream dataFileUsing =
                        new FileStream(Path.Combine(ProjectPath.Path_data, "WarningValueUsing.dat"), FileMode.Create);
