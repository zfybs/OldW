...
namespace rvtTools
{
    public class FilterTools
    {
        ...
        public static Boolean existFamliyByName(Document doc, String name, out ElementId foundId)
        {
            String famName = name;
            Boolean found = false;
            foundId = null;
        ...
        /// <param name="name">族名称</param>
        /// <returns>返回是否包含</returns>
        public static Boolean existFamliyByName(Document doc, String name)
        {
            String famName = name;
            Boolean found = false;
            FilteredElementCollector collector = new FilteredElementCollector(doc);
        ...
        public static Family getFamilyByName(Document doc, String name)
        {
            ...
            try
            {
                fam = foundId.Element(doc) as Family;
            }
            catch (Exception ex)
            {
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public static ICollection<ElementId> getFamilyInstancesByFamilyName(Document doc, String name)
        {
        ...
        /// <returns></returns>
        public static ICollection<ElementId> getFamilyInsancesByFamilySymbolId(Document doc, ElementId familySymbolId)
        {
        ...
        /// <returns></returns>
        public static List<ElementId> getFamilyInsancesByFamilySymbolIds(Document doc, ISet<ElementId> familySymbolIds)
        {
